...
function App() {
  ...
  return (
    <div className="fixed inset-0 bg-black text-white font-sans flex flex-col overflow-hidden">
      ...
      {/* --- LAYER 4: BOTTOM BAR --- */}
      <div className={`absolute bottom-0 left-0 right-0 z-30 pt-12 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] transition-all duration-500 ease-in-out ${(isFocusMode && !result) || isLoading ? 'bg-transparent pointer-events-none' : 'bg-gradient-to-t from-black via-black/90 to-transparent'}`}>
